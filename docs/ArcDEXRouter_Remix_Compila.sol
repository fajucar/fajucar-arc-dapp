...
// =============================================================================
// ArcDEXRouter — COLE NO REMIX (compila sem Stack too deep)
// =============================================================================
// Config: Compiler 0.8.20 | Optimizer 200 | viaIR false
// Deploy: constructor = 0x0521040935960c6883B9AaBD9927F7889B0790f2 (Factory)
// =============================================================================
...
interface IArcDEXPair {
    ...
    // Aceita Pair que retorna 2 ou 3 valores
...
contract ArcDEXRouter {
    ...
    /** @dev Indica suporte a tokens precompile (ex.: USDC na Arc). O frontend usa para detectar versão correta. */
