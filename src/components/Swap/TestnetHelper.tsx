        ...
        <div className="mt-3 pt-3 border-t border-slate-700/50 flex flex-wrap gap-2">
          {canMintFaju && (
            <button
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium bg-cyan-500/20 text-cyan-300 hover:bg-cyan-500/30 border border-cyan-500/40 disabled:opacity-50"
            >
